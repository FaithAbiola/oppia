import './PointsBalanceCard.css'

const PointsBalanceCard = ({ points, targetPoints = 5000 }) => {
    ...
    <div className="points-balance-card">
      <div className="card-header">
        <svg
          ...
          data-prefix="fas"
          data-icon="award"
          className="card-icon svg-inline--fa fa-award"
        ...
        <h3 className="card-title">Points Balance</h3>
      </div>
      <div className="points-display">
        <span className="points-value">{points.toLocaleString()}</span>
        <div className="lf-player-container">
          <div id="lottie" style={{ background: 'transparent', margin: '0px auto', outline: 'none', overflow: 'hidden', height: '100px', width: '100px' }}>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 480 480" width="480" height="480" preserveAspectRatio="xMidYMid meet" style={{ width: '100%', height: '100%', transform: 'translate3d(0px, 0px, 0px)', contentVisibility: 'visible' }}>
              <defs>
                <clipPath id="__lottie_element_2"><rect width="480" height="480" x="0" y="0"></rect></clipPath>
                <linearGradient id="__lottie_element_9" spreadMethod="pad" gradientUnits="userSpaceOnUse" x1="-50.06999969482422" y1="-91.03900146484375" x2="70.08200073242188" y2="67.8030014038086">
                ...
                <linearGradient id="__lottie_element_16" spreadMethod="pad" gradientUnits="userSpaceOnUse" x1="-36.17599868774414" y1="-68.43900299072266" x2="52.7599983215332" y2="47.957000732421875">
                  <stop offset="0%" stopColor="rgb(255,233,0)"></stop>
                  <stop offset="50%" stopColor="rgb(255,199,0)"></stop>
                  <stop offset="100%" stopColor="rgb(255,166,0)"></stop>
                </linearGradient>
                <linearGradient id="__lottie_element_20" spreadMethod="pad" gradientUnits="userSpaceOnUse" x1="4" y1="-55" x2="4" y2="35.52299880981445">
                ...
                <g id="__lottie_element_27">
                  <g transform="matrix(1,0,0,1,237,247)" opacity="1" style={{ display: 'block' }}>
                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                      <path fill="rgb(35,21,38)" fillOpacity="1" d=" M3,-107 C-52.22800064086914,-107 -97,-62.229000091552734 -97,-7 C-97,48.22800064086914 -52.22800064086914,93 3,93 C58.22800064086914,93 103,48.22800064086914 103,-7 C103,-62.229000091552734 58.22800064086914,-107 3,-107z M3,73 C-41.18299865722656,73 -77,37.18299865722656 -77,-7 C-77,-51.18299865722656 -41.18299865722656,-87 3,-87 C47.18299865722656,-87 83,-51.18299865722656 83,-7 C83,37.18299865722656 47.18299865722656,73 3,73z"></path>
                    </g>
                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                      <path fill="rgb(35,21,38)" fillOpacity="1" d=" M3,-79.5 C-37.04100036621094,-79.5 -69.5,-47.04100036621094 -69.5,-7 C-69.5,33.04100036621094 -37.04100036621094,65.5 3,65.5 C43.04100036621094,65.5 75.5,33.04100036621094 75.5,-7 C75.5,-47.04100036621094 43.04100036621094,-79.5 3,-79.5z"></path>
                    </g>
                  </g>
                </g>
                ...
                <mask id="__lottie_element_27_1" maskType="alpha">
      ...
      <div className="progress-section">
        <div className="progress-label">
          <span><span className="font-medium">Progress to</span> <span className="font-semibold">$5 Gift Card</span></span>
